...
Revision ID: f265255d83f5
Revises: 
Create Date: 2025-06-04 20:08:02.231710
...
def upgrade() -> None:
    ...
    sa.Column('categoria_treinamento_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['categoria_treinamento_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
